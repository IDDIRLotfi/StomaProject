  ...
  <div class="modal-dialog"  role="document" style="width: 70%">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Dossier N° : xxx</h5>
		<h5 class="modal-title" id="exampleModalLongTitle">Nom Preom : hgsygu</h5>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class="apercu_c"><a href="#" data-toggle="modal" data-target="#exampleModalLong">Aperçu</a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
