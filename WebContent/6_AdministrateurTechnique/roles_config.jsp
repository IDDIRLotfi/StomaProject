              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <!--li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="" id="imgAgent" name="imgAgent">Nesrine
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="login.jsp"><i class="fa fa-sign-out pull-right"></i> Log O</a></li>
                  </ul>
                </li-->
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<div class="row row_form col-sm-12 div_border">
				 ...
				 <button type="button" class="btn btn-success btn-xs col-sm-1" id="btnCree" name="btnCree"  style="float:right" onclick =''>Creer</button>
				 <button type="button" class="btn btn-success btn-xs col-sm-1" id="btnModifier" name="btnModifier"  style="float:right" onclick =' window.location= "";'>Modifier</button>
			</div>
			
			<div class="x_content">
                    <br>
			 <form id="formId" data-parsley-validate="" class="form-horizontal form-label-left input_mask" novalidate="">
			 <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" style="width: 50%;text-align:left"for="identifiant">Identifiant</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="identifiant"  name="identifiant" class="form-control col-md-7 col-xs-12"style="width:400%">
                        </div>
                      </div>
					    </form>
					   </br>
					  ...
					  <br>
					  <form id="formDesc" data-parsley-validate="" class="form-horizontal form-label-left input_mask" novalidate="">
					
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"style="width: 50%;text-align:left">Description </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea class="form-control" id="Desc" name="Desc" rows="3" style="width:5000%" placeholder=''></textarea>
                        </div>
                      </div>
					  </form>
					  </br>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Droit </th>
