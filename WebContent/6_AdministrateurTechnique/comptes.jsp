...
<html lang="fr">
  <head>
    ...
    <title>StomIT | Gestion des comptes</title>
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
		  ...
		  <label class="col-md-3 col-sm-3 col-xs-12" id="test" for="trier" > Trier par </label>
					  <div class="col-md-3 col-sm-3 col-xs-12">
						<select id="heard" class="form-control col-md-3 col-xs-12" id="trier" name="trier" required="required" style="margin-left:10px">
                            <option value="" id="" name="" >Choisir..</option>
                            <option value="press" id="" name="">N°</option>
                            <option value="net" id="" name="" >Nom</option>
                            <option value="net" id="" name="" >Login</option>
                          </select>
						</div>
				 ...
				 <button type="button" class="btn btn-success btn-xs col-sm-1"  id="btn-creer" name="btn-creer"  style="float:right" onclick =''>Creer</button>
				 <button type="button" class="btn btn-success btn-xs col-sm-1"  id="btn-modif" name="btn-modif" style="float:right" onclick =' window.location= "";'>Modifier</button>
			</div>
						  <div class="clearfix"></div>
