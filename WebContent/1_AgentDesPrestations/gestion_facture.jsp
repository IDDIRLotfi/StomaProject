      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
				<div class="row row_form col-sm-12">
					...
					<button type="button" class="btn btn-success btn-xs col-sm-1" id="btn-new" name = "btn-new" style ="float:right;" onclick =' window.location= "/Stomise/GestionFactureForm";'>Nouveau</button>
				</div>
          ...
          <div class="">
           <div class="TABLE_C">
					...
					<c:forEach items="${listeFactures}" var="facture" varStatus = "status">
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" " id="" name="" ><c:out value="${facture.idFacture}">  </c:out></td>                            
                            <td class=" " id="" name="" ><c:out value="${facture.bl.idBL}">  </c:out></td>                            
                            <td class=" " id="" name="" ><c:out value="${facture.patient.nom}"> </c:out></td>
							<td class=" " id="" name="" ><c:out value="${facture.patient.prenom}"> </c:out></td>
							<td class=" " id="" name="" ><c:out value="${facture.etat}"></c:out></td>						
                           <td class=" " id="" name="" ><c:out value="${facture.dateFacture}"></c:out></td>
