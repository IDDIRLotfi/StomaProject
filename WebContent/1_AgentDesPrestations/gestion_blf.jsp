    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
				...
				<button type="button" class="btn btn-success btn-xs col-sm-1" id="btnNew" name="btnNew" style ="float:right;" onclick =' window.location= "gestion_blf_form.jsp" ;'>Nouveau</button></div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
							...
							<th class="column-title">N° BLF </th>
                        ...
                        <tbody>
                         <c:forEach items="${listeBLFs}" var="blf" varStatus = "status">
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" " id="" name="" ><c:out value="${blf.idBLF}">  </c:out></td>                            
                            <td class=" " id="" name="" ><c:out value="${blf.devis.idDevis}">  </c:out></td>
                            <td class=" " id="" name="" ><c:out value="${blf.patient.idPatient}"> </c:out></td>
                            <td class=" " id="" name="" ><c:out value="${blf.patient.nom}"> </c:out></td>
							<td class=" " id="" name="" ><c:out value="${blf.patient.prenom}"> </c:out></td>
							<td class=" " id="" name="" ><c:out value="${blf.etat}"></c:out></td>
