          ...
          <div class="nav_menu">
            <nav>
			  ...
			  <li class="">
                ...
                <!--li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="${sessionScope.utilisateur.urlphoto}" alt="imgAgent">Hafidh
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
        ...
        <div class="right_col" role="main">
				<div class="row row_form col-sm-12">
				 <div class="form-group ss col-sm-11">
                        <label class="control-label col-sm-4" id="trier" name="trier" >Trier par</label>
						
						
                        <div class="col-sm-6">
                          <select class="form-control ss" id="option" name="option" >
				...
				<button type="button" class="btn btn-success btn-xs col-sm-1" style ="float:right;"  id="" name="" onclick =' window.location= "gestion_bl_form.jsp" ;'>Nouveau</button>
			</div>
          ...
          <div class="">
           <div class="TABLE_C">
                      <table class="table table-striped jambo_table bulk_action">
						...
						<c:forEach items="${listeBLs}" var="bl" varStatus = "status">
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" " id="" name="" ><c:out value="${bl.idBL}">  </c:out></td>                            
                            <td class=" " id="" name="" ><c:out value="${bl.devis.idDevis}">  </c:out></td>
                            <td class=" " id="" name="" ><c:out value="${bl.patient.idPatient}"> </c:out></td>
                            <td class=" " id="" name="" ><c:out value="${bl.patient.nom}"> </c:out></td>
							<td class=" " id="" name="" ><c:out value="${bl.patient.prenom}"> </c:out></td>
							<td class=" " id="" name="" ><c:out value="${bl.etat}"></c:out></td>
                            <td class="apercu_c" id="" name="" ><a href="#">Aperçu</a></td>
                          </tr>
                        </tbody>
                        </c:forEach>
