    ...
    <div class="container body">
      <div class="main_container">
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <!--li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="${sessionScope.utilisateur.urlphoto}" alt="" id="nomAgent" name="">Hafidh
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
		...
		<div class="row row_form col-sm-12">
				...
				<button type="button" class="btn btn-success btn-xs col-sm-1" id="btn_new" name="btn_new" style ="float:right; " onclick =' window.location= "1_AgentDesPrestations/Prise_en_charge_form.jsp" ;' >Nouveau</button>
				<a></a>
			</div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">N° PC </th>
                            <th class="column-title">NSS patient </th>
                            <th class="column-title">Nom patient </th>
                            <th class="column-title">Prénom patient </th>
                            <th class="column-title">Organisme d'assurance</th>
                       ...
                       <c:forEach items="${listePCs}" var="pc" varStatus = "status">
                        <tbody>
                          <tr class="even pointer">
                            <td class="a-center ">
                              <input type="checkbox" class="flat" id="" name="" name="table_records">
                            </td>
                            <td class=" " id="" name="" ><c:out value="${status.index}"></c:out></td>
                            <td class=" " id="" name="" ><c:out value="${pc.idPC}">  </c:out></td>                            
                            <td class=" " id="" name="" ><c:out value="${pc.patient.idPatient}">  </c:out></td>                            
                            <td class=" " id="" name="" ><c:out value="${pc.patient.nom}"> </c:out></td>
							<td class=" " id="" name="" ><c:out value="${pc.patient.prenom}"> </c:out></td>
							<td class=" " id="" name="" ><c:out value="${pc.officine}"></c:out></td>
                            <td class="apercu_c" id="" name="" ><a href="Prise_en_charge_form.jsp">Aperçu</a></td>
                          </tr>
                        </tbody>
                        </c:forEach>
                      </table>
