        ...
        <div class="right_col" role="main">
          <div class="">
					 ...
					 <div class="row row_form col-sm-12 div_border stock_view">
						 ...
						 <div class="col-sm-3" style="margin-left: 23px;"> </div>
						 <button type="button" class="btn btn-success btn-xs col-sm-1 btn_stock_view" id="btn-ajout" name="btn-ajout"
						 style="margin-left: 340px;"
						 onclick =' window.location= "Mouvement_Entree_form.jsp";'>Ajouter</button>
						 
						 <button type="button" class="btn btn-success btn-xs col-sm-1" id="btn-supp" name="btn-supp"  onclick ='window.location="Mouvement_Bon_Entree_Tempo.jsp";'>Supprimer</button>
						 <button type="button" class="btn btn-success btn-xs col-sm-1" id="btn-enreg" name="btn-enreg" onclick ='window.location="Mouvement_Entree.jsp";'>Enregistrer</button>
					  </div>
...
#test3 {
	...
	margin-left: 80%;
	 ...
	 <link href="../build/css/custom_stom_2.css" rel="stylesheet">
    <!-- Custom Theme Style -->
    <link href="../build/css/custom.min_2.css" rel="stylesheet">
