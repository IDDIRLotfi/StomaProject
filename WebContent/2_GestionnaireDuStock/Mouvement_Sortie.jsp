        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="clearfix">
				<h4 id="roleAgent" name="roleAgent">   Magasinier </h4>
			  </div>
            </div>
            <!-- /menu profile quick info -->
        ...
        <div class="right_col" role="main">
          <div class="">
					 ...
					 <div class="row row_form col-sm-12 div_border stock_view">
						 ...
						 onclick =' window.location= "Mouvement_Sortie_form.jsp";'>Nouveau</button>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
							...
							<th class="column-title" >Ref.B.Sortie</th>
                            <th class="column-title" >Ref.BL</th>
                            <th class="column-title" >Ref.BLF</th>
