        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;background:#023232">
              <a href="index.jsp" class="site_title"> <img src=".././images/Sans titre-1.png" style="height:50px" alt="..."><span>  Stomis̩</span></a>
            </div>
        ...
        <div class="right_col" role="main">
          <div class="">
					 ...
					 <div class="row row_form col-sm-12 div_border stock_view">
						 ...
						 <button type="button" class="btn btn-success btn-xs col-sm-1 btn_stock_view" 
						 style="margin-left: 550px;" id="btn-imprimer" name="btn-imprimer" onclick =' window.location= "";'>Imprimer</button>
					  </div>
