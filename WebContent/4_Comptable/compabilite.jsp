...
<html lang="fr">
  <head>
    ...
    <title>StomIT | Comptabilité</title>
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Bienvenue,</span>
                <h2 id="nomAgent" name="nomAgent" >Lotfi</h2>	
              </div>
              <div class="clearfix">
				<h4 style="text-align:center" id="roleAgent" name="roleAgent" >Role: Comptable</h4>
			  </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
				  ...
				  <li><a  href="#"><i class="fa fa-home"></i> Les écritures  </a></li>
				  <li><a  href="#"><i class="fa fa-home"></i> Bilan  </a></li>
				  <li><a  href="#"><i class="fa fa-home"></i> Journal  </a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <!--li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="" id="" name="" >Lotfi
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<div class="row row_form col-sm-12 div_border">
				 <h2 class="title_pos col-sm-6">Les écritures comptables </h2>
				 <button type="button" class="btn btn-success btn-xs col-sm-1" id="btn-impr" name="btn-impr" onclick =''>Imprimer</button>
				 <button type="button" class="btn btn-success btn-xs col-sm-1" id="btn-ajout" name="btn-ajout" onclick =''>Ajouter</button>
				 <button type="button" class="btn btn-success btn-xs col-sm-1" id="btn-modif" name="btn-modif" onclick =' window.location= "";'>Modifier</button>
			</div>
						  <div class="clearfix"></div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
							...
							<th class="column-title">N° Compte debit </th>
							<th class="column-title">N° Compte credit </th>
                            <th class="column-title">Date </th>
                            
                            <th class="column-title">Libellé </th>
                        <th class="column-title">Montant débit </th>
                            <th class="column-title">Montant crédit </th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" " id="" name="" ></td>
							<td class=" " id="" name="" ></td>
                            <td class="a-right a-right " id="" name="" ></td>
